...
const App_3_2 = ({ navigation, route }) => {
  ...
  const handleNextPress = () => {
    if (selectedOption == "yes") {
      navigation.navigate("App_3_2_1", { name, dateRegistered });
    }

    if (selectedOption == "no") {
      navigation.navigate("App_3_1_2", { name, dateRegistered });
    }
  };
